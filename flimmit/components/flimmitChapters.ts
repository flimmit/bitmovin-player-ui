import {ToggleButton, ToggleButtonConfig} from './../../src/ts/components/togglebutton';
 ...
 */
export class FlimmitChapters extends ToggleButton<SettingsToggleButtonConfig> {
    ...
    constructor(config: SettingsToggleButtonConfig) {
        ...
        this.config = this.mergeConfig(config, {
            cssClass: 'ui-chaptertogglebutton',
            text: 'Chapters',
            settingsPanel: null,
